...
class Calculation:
    ...
    def is_integer_result(self) -> bool:
        return self.result == int(self.result)

    def round_result(self, digits: int = 2) -> Decimal:
        return self.result.quantize(Decimal(10) ** -digits)
    ...
    def clone_with_new_operands(self, operand1: Decimal, operand2: Decimal) -> 'Calculation':
        return Calculation(operation=self.operation, operand1=operand1, operand2=operand2)

    def is_same_operation(self, other: 'Calculation') -> bool:
